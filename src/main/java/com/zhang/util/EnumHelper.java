...
public final class EnumHelper implements Serializable {
	...
	public static <T extends Enum<T>> T translate(final Class<T> clazz, final String code) {
		try {
			...
			// ignore
			LOGGER.error("failed to translate label {} into object of type {}", code, clazz);
		}
	...
	public static <T extends Enum<T>> T translateByValue(final Class<T> clazz, final String value) {
		try {
			...
			// ignore
			LOGGER.error("failed to translate value {} into object of type {}", value, clazz);
		}
		LOGGER.error("failed to translate value {} into object of type {}", value, clazz);
		return null;
	}
